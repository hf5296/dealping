        ...
        <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
            ...
            <main className="py-8">
                <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    {/* Page Header */}
                    <div className="mb-8">
                        <div className="mb-2 h-6 w-32 animate-pulse rounded-full bg-gray-200 dark:bg-gray-700" />
                        <div className="h-10 w-64 animate-pulse rounded bg-gray-200 dark:bg-gray-700" />
                        <div className="mt-2 h-5 w-80 animate-pulse rounded bg-gray-200 dark:bg-gray-700" />
                    </div>
